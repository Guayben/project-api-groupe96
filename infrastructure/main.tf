...
module "app_service" {
  ...
  cosmosdb_endpoint       = var.cosmosdb_endpoint         # Endpoint de CosmosDB pour l'application.
  ...
  cosmosdb_container_name = var.cosmosdb_container_name   # Nom du conteneur CosmosDB.
}
